    ...
    <div class="section">
        <div class="container">
             ...
             <div class="box">
                ...
                <?php
              $qt = mysqli_query($conn, "SELECT SUM(suka) FROM likefoto WHERE image_id = '".$_GET['id']."'");
			  if(mysqli_num_rows($qt) > 0){
		  		...
		  		?>
                   ...
                   if(isset($_POST['suka'])){
					   ...
					   $cekk = mysqli_query($conn, "SELECT * FROM likefoto WHERE admin_name='".$adname."' AND image_id='".$gam."'");
					   if(mysqli_num_rows($cekk) > 0){
						   echo  $hapus=mysqli_query($conn, "DELETE FROM likefoto WHERE admin_name='".$adname."' AND image_id='".$gam."'");
						   if($hapus){
					   ...
					   $insert = mysqli_query($conn, "INSERT INTO likefoto VALUES (
						               null,
									   '".$gam."',
									   '".$adname."',
									   '1',
